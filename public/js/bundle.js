...
var showAlert = function showAlert(type, msg) {
  ...
  document.querySelector('body').insertAdjacentHTML('afterbegin', markup); //inside of the body and right at the beginning
...
var bookTour = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(tourId) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          stripe = Stripe('pk_test_51MUSzJSErNw1bi0ReYXqHw1kIymhBanYb0pwlDafRMgYZO6CTP3MRVHJ0PmiFBriwvHeVcEpNz9oRabhq2cxAld500qIOjRkde'); // 1 get checkout session from server
          _context.prev = 1;
          _context.next = 4;
...
var pwdbtn = document.querySelector('.btn--green.btn--save-password');
...
if (bookBtn) {
  bookBtn.addEventListener('click', function (e) {
    ...
    var tourId = e.target.dataset.tourId; //e-target is the ellement that is clicked
